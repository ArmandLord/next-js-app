...
const navigation = [
  { name: 'R&M-API', href: 'https://rickandmortyapi.com/', current: true, target: true },
      ...
      <div className="min-h-full">
                ...
                <div className="flex items-center justify-between h-16">
                  <div className="flex items-center">
                    <div className="flex-shrink-0">
                      <img
                        className="h-8 w-10"
                        src="https://res.cloudinary.com/dy9tey0yi/image/upload/v1641173759/logo-morty_s9qgt9.png"
                        alt="Workflow"
                      />
                    </div>
        ...
        <header className="bg-white shadow">
          <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
            <h1 className="text-3xl font-bold text-gray-900">{numCharacters} Characters</h1>
          </div>
        </header>
        <main>
